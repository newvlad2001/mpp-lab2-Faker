...
namespace Faker.UnitTests
{
    ...
    class LibraryTests
    {
        ...
        public void Setup()
        {
            Assembly.LoadFile(@"D:\Projects\StudioProjects\C# projects\Faker\Faker.IntGenerator\bin\Debug\net5.0\Faker.IntGenerator.dll");
            Assembly.LoadFile(@"D:\Projects\StudioProjects\C# projects\Faker\Faker.ListGenerator\bin\Debug\net5.0\Faker.ListGenerator.dll");
            faker = new FakerImpl();
        }
